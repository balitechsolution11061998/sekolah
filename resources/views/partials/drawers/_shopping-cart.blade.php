	...
	<div class="card card-flush w-100 rounded-0">
		...
		<div class="card-header">
			...
			<div class="card-toolbar">
				<!--begin::Close-->
				<div class="btn btn-sm btn-icon btn-active-light-primary" id="kt_drawer_shopping_cart_close">{!! getIcon('cross', 'fs-2') !!}</div>
				<!--end::Close-->
			</div>
			<!--end::Card toolbar-->
		</div>
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex flex-column me-3">
					...
					<div class="d-flex align-items-center">
						...
						<a href="#" class="btn btn-sm btn-light-success btn-icon-success btn-icon w-25px h-25px me-2">{!! getIcon('minus', 'fs-4') !!}</a>
